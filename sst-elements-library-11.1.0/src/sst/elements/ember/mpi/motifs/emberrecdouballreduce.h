#ifndef _H_EMBER_RECDOUBALLREDUCE_MOTIF
#define _H_EMBER_RECDOUBALLREDUCE_MOTIF
...
class EmberRecDoubAllreduceGenerator : public EmberRecDoubCollGenerator {

public:
    SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(
        EmberRecDoubAllreduceGenerator,
        "ember",
        "RecDoubAllreduceMotif",
    ...
    SST_ELI_DOCUMENT_PARAMS(
        ...
        {"arg.dimensions", "Number of topology dimensions", "1"},
...
public:
	EmberRecDoubAllreduceGenerator(SST::ComponentId_t, Params& params);
    ~EmberRecDoubAllreduceGenerator();
    bool generate(std::queue<EmberEvent*>& evQ);

private:
    RecDoubCollective* m_allreduce;
    int m_recvcount;
    int m_validate;
    float* m_data;
