...
class EmberSwingAllreduceGenerator : public EmberSwingCollGenerator {

public:
    SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(
        EmberSwingAllreduceGenerator,
        "ember",
        "SwingAllreduceMotif",
...
public:
	EmberSwingAllreduceGenerator(SST::ComponentId_t, Params& params);
    ~EmberSwingAllreduceGenerator();
    bool generate(std::queue<EmberEvent*>& evQ);

private:
    SwingCollective* m_allreduce;
    int m_recvcount;
    int m_validate;
    float* m_data;
