#ifndef _H_EMBER_BRUCKALLGATHER_MOTIF
#define _H_EMBER_BRUCKALLGATHER_MOTIF
...
class EmberBruckAllgatherGenerator : public EmberBruckCollGenerator {

public:
    SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(
        EmberBruckAllgatherGenerator,
        "ember",
        "BruckAllgatherMotif",
...
public:
	EmberBruckAllgatherGenerator(SST::ComponentId_t, Params& params);
    ~EmberBruckAllgatherGenerator();
    bool generate(std::queue<EmberEvent*>& evQ);

private:
    BruckCollective* m_allgather;
};
