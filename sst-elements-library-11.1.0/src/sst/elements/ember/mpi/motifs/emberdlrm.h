...
class EmberDLRMGenerator : public EmberHxMeshGenerator {
...
public:
	EmberDLRMGenerator(SST::ComponentId_t, Params& params);
    ~EmberDLRMGenerator();
...
private:
    ...
    EmberRingAllreduce* m_allreduce1;
    EmberRingAllreduce* m_allreduce2;
