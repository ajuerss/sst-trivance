#ifndef _H_EMBER_TRIVANCEALLGATHER_MOTIF
#define _H_EMBER_TRIVANCEALLGATHER_MOTIF
...
class EmberTrivanceAllgatherGenerator : public EmberTrivanceCollGenerator {

public:
    SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(
        EmberTrivanceAllgatherGenerator,
        "ember",
        "TrivanceAllgatherMotif",
...
public:
	EmberTrivanceAllgatherGenerator(SST::ComponentId_t, Params& params);
    ~EmberTrivanceAllgatherGenerator();
    bool generate(std::queue<EmberEvent*>& evQ);

private:
    TrivanceCollective* m_allgather;
};
