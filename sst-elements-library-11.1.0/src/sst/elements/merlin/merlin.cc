...
char pymerlin_topo_hamming[] = {
#include "topology/pymerlin-topo-hamming.inc"
    0x00};
...
public:
        ...
        SSTElementPythonModule(library)
    {
        ...
        primary_module->addSubModule("topology",pymerlin_topo_hamming,"topology/pymerlin-topo-hamming.py");
    }
