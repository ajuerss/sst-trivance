...
namespace SST
{
  namespace Firefly
  {
    ...
    public:
      ...
      {
        //printf("group %p: getMapping: from: %d; m_numCores: %d; from / m_numCores: %d; m_netMap: %p; m_size: %d; m_netMap[from / m_numCores]: %d\n", this, from, m_numCores, from / m_numCores, m_netMap, m_size, m_netMap[from / m_numCores]);
