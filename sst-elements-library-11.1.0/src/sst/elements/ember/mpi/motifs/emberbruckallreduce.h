#ifndef _H_EMBER_BRUCKALLREDUCE_MOTIF
#define _H_EMBER_BRUCKALLREDUCE_MOTIF
...
class EmberBruckAllreduceGenerator : public EmberBruckCollGenerator {

public:
    SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(
        EmberBruckAllreduceGenerator,
        "ember",
        "BruckAllreduceMotif",
...
public:
	EmberBruckAllreduceGenerator(SST::ComponentId_t, Params& params);
    ~EmberBruckAllreduceGenerator();
    bool generate(std::queue<EmberEvent*>& evQ);

private:
    BruckCollective* m_allreduce;
    int m_recvcount;
    int m_validate;
    float* m_data;
