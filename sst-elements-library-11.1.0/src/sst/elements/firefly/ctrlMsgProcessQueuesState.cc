        ...
        m_recvdMsgQpos(0)
{
    ...
    m_maxPostedShortBuffers = params.find<int32_t>("pqs.maxPostedShortBuffers",32768); 
...
{
    //printf("Posting Recv2 %d %d %d %d<\n", m_nic->getNodeId(),m_maxPostedShortBuffers,  m_numNicRequestedShortBuff, m_numRecvLooped);
