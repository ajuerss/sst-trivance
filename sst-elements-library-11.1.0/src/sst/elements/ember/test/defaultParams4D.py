...
hermesParams = {
    ...
    #"hermesParams.ctrlMsg.shortMsgLength" : 2147483642,
    "hermesParams.ctrlMsg.shortMsgLength" : valueShort,
    ...
    "hermesParams.ctrlMsg.rxSetupModParams.range.0" : "0-15:0ns",

    "hermesParams.ctrlMsg.txMemcpyMod" : "firefly.LatencyMod",
    "hermesParams.ctrlMsg.txMemcpyModParams.op" : "Mult",
    "hermesParams.ctrlMsg.txMemcpyModParams.range.0" : "0-:0ps",

    "hermesParams.ctrlMsg.rxMemcpyMod" : "firefly.LatencyMod",
    "hermesParams.ctrlMsg.txMemcpyModParams.op" : "Mult",
    "hermesParams.ctrlMsg.rxMemcpyModParams.range.0" : "0-:0ps",
