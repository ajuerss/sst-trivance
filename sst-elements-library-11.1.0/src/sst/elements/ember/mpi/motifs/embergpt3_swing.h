...
class EmberGPT3SwingGenerator : public EmberSwingCollGenerator {

public:
    SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(
        EmberGPT3SwingGenerator,
        "ember",
        "GPT3SwingMotif",
    ...
    SST_ELI_DOCUMENT_PARAMS(
        ...
        {"arg.all_reduce_type", "All Reduce Type (SwingB | SwingL)", "SwingB"},
        {"arg.compscaling", "", "1"},
...
public:
	EmberGPT3SwingGenerator(SST::ComponentId_t, Params& params);
    ~EmberGPT3SwingGenerator();
...
private:
    ...
    SwingCollective* m_mp_allreduce;
    SwingCollective* m_dp_allreduce;
